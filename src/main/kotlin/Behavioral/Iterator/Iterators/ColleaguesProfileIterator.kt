...
class ColleaguesProfileIterator(private val network: SocialNetwork, private val forId: Int) : ProfileIterator {
    ...
    private fun lazyLoadState() {
        state = state ?: network.getProfilesGraph(forId = forId, type = ProfileType.COLLEAGUES)
    }
}